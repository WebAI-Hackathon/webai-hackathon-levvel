...
import { Canvas as FabricCanvas, Image as FabricImage, Circle, Rect, Textbox, Path } from "fabric";
...
export const EditorCanvas = ({ 
  ...
  useEffect(() => {
    ...
    // Initialize drawing brush - ensure it exists and is properly configured
  ...
  return (
    <div className="flex flex-col">
      <div 
        className="relative border-2 border-dashed border-border overflow-hidden bg-background flex-1"
        onDrop={handleDrop}
